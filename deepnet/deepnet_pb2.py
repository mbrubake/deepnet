...
_DATASET_DATA = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='img', full_name='deepnet.Dataset.Data.img', index=7,
      number=9, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='patchsize', full_name='deepnet.Dataset.Data.patchsize', index=4,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='patchstride', full_name='deepnet.Dataset.Data.patchstride', index=4,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='patchnormalize', full_name='deepnet.Dataset.Data.patchnormalize', index=7,
      number=13, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='patchrotate', full_name='deepnet.Dataset.Data.patchrotate', index=7,
      number=14, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
