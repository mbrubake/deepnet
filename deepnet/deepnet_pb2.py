...
_PARAMETER_INITIALIZATION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONV_GAUSSIAN_GREY', index=7, number=7,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_DATASET_DATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='img', full_name='deepnet.Dataset.Data.img', index=9,
      number=10, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='valid_file_pattern', full_name='deepnet.Dataset.Data.valid_file_pattern', index=10,
      number=11, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='patchsize', full_name='deepnet.Dataset.Data.patchsize', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='patchstride', full_name='deepnet.Dataset.Data.patchstride', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='patchnormalize', full_name='deepnet.Dataset.Data.patchnormalize', index=13,
      number=14, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='patchrotate', full_name='deepnet.Dataset.Data.patchrotate', index=14,
      number=15, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='patchrandoffset', full_name='deepnet.Dataset.Data.patchrandoffset', index=15,
      number=16, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
